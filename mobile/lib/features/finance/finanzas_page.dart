          ...
          child: Column(
            ...
            children: [
              ...
              if (net != null && _kpiDelta(net, fin.currency) != null) ...[
                const SizedBox(height: 4),
                Text(
                  '${_kpiDelta(net, fin.currency)} ${s.financeVsPrevious}',
                  style: TextStyle(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            formatMoney(p.marginAmount, fin.currency),
                            style: const TextStyle(fontWeight: FontWeight.w600),
                          ),
                          Icon(
                            Icons.chevron_right,
                      ...
                      child: Row(
                        children: [
                          Icon(
                            ...
                            size: 14,
                            color: r.delta >= 0 ? scheme.error : scheme.primary,
                          ),
                          const SizedBox(width: 6),
