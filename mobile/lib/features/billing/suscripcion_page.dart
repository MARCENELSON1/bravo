...
class _ActiveCard extends ConsumerWidget {
    ...
    return GlassPanel(
      child: Column(
        ...
        children: [
          ...
          Text(
            '${s.billingStatusLine(s.billingStatusLabel(subscription.status))}$end',
  ...
  Future<void> _cancel(BuildContext context, WidgetRef ref) async {
    ...
    final ok = await confirmDialog(
      context,
      title: s.billingCancelConfirm,
      confirmLabel: s.billingCancel,
    );
    if (!ok) return;
    try {
      ...
      children: [
        ...
        plans.when(
          ...
          data: (list) {
            ...
            return Column(children: [for (final p in list) _PlanCard(plan: p)]);
          },
        ),
      ],
    );
