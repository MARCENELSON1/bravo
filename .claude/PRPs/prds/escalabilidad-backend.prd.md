...
| 3 | Escalado horizontal | Bus compartido (Redis pub/sub) + rate limiter compartido + colas SSE con `maxsize`; recién ahí, `--workers`/réplicas | in-progress | - | 1, 2 | `.claude/PRPs/plans/escalabilidad-fase-3-escalado-horizontal.plan.md` |
