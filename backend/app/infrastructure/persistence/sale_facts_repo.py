...
def _to_domain(row: SaleFactORM) -> SaleFact:
    return SaleFact(
        ...
        food_cost_net_amount=row.food_cost_net_amount,
        recipe_version=row.recipe_version,
        options_amount=row.options_amount,
...
def _to_orm(fact: SaleFact) -> SaleFactORM:
    return SaleFactORM(
        ...
        line_net_amount=fact.line_net_amount,
        food_cost_amount=fact.food_cost_amount,
        food_cost_net_amount=fact.food_cost_net_amount,
        recipe_version=fact.recipe_version,
        options_amount=fact.options_amount,
