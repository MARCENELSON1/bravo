...
// with solid dots (inner contours removed → no holes). Transparent background,
// inherits color via `currentColor`. The viewBox is cropped to the mark.
  ...
  return (
    ...
    >
      ...
      >
        ...
        <path d="M1523 3088 c-9 -20 -50 -38 -221 -100 -191 -69 -214 -76 -242 -65 -26 10 -33 9 -51 -10 -26 -26 -18 -60 17 -69 26 -7 54 10 54 32 0 20 -13 17 -28 -7 -10 -16 -16 -18 -27 -9 -19 16 -7 50 19 50 12 0 27 -5 33 -11 7 -7 26 -4 64 11 30 12 92 35 139 51 47 17 114 42 149 56 43 16 76 23 97 20 41 -7 67 11 62 44 -4 34 -50 39 -65 7z" />
